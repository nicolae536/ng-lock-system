...
import { LOCK_STATUS } from "./lock.constants";
...
var LockManagerService = /** @class */ (function () {
    function LockManagerService(enableLogging, _util) {
        this._util = _util;
        this._managerLock$ = new BehaviorSubject({});
        if (enableLogging) {
            this.startLogging();
        }
    }
    ...
    LockManagerService = __decorate([
        Injectable(),
        __param(0, Inject(ENABLE_LOGGING)),
        __metadata("design:paramtypes", [Boolean, UtilService])
    ], LockManagerService);
    return LockManagerService;
}());
export { LockManagerService };
//# sourceMappingURL=lock-manager.service.js.map